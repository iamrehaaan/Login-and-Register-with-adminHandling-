...
exports.forgotPasswordVerification = async (email, name, _id, token) => {
  try {
    ...
    const configureOption = {
      ...
      html: `<p>Welcome ${name},<a href="http://localhost:3002/reset-password?token=${token}"> Click here to reset your password </a> </p>`, // html body
    };
